...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td align="right" valign="middle">
      <p style="font-family: 'MS Sans Serif', Arial, sans-serif; font-size: 13px; margin: 0;">
        <a href="#sobre-mi" style="color: #ff007f; text-decoration: none; font-weight: bold;">[ Sobre Mí ]</a> &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="#habilidades" style="color: #a0a0a5; text-decoration: none; font-weight: bold;">[ Habilidades ]</a> &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="#experiencia" style="color: #a0a0a5; text-decoration: none; font-weight: bold;">[ Experiencia ]</a> &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="#contacto" style="color: #a0a0a5; text-decoration: none; font-weight: bold;">[ Contacto ]</a>
      </p>
    </td>
  </tr>
</table>

<hr border="1" color="#ff007f" style="opacity: 0.3; margin-top: 15px; margin-bottom: 30px;">
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="50%" align="center" valign="middle">
      ...
      <img src="./cat-animation.svg?v=4" width="100%" alt="Winamp Cat Player" />
    </td>
  </tr>
</table>
...
<!-- SECCIÓN: HABILIDADES -->
<a id="habilidades"></a>
<h2 style="color: #ff007f; font-family: 'MS Sans Serif', Arial, sans-serif; font-size: 24px; margin-bottom: 25px;">Habilidades &amp; Tecnologías</h2>

<table border="0" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td width="32%" align="center" valign="top">
      <img src="./card-languages.svg?v=3" width="100%" alt="Lenguajes" />
    </td>
    <td width="2%"></td>
    <td width="32%" align="center" valign="top">
      <img src="./card-education.svg?v=3" width="100%" alt="Educación" />
    </td>
    <td width="2%"></td>
    <td width="32%" align="center" valign="top">
      <img src="./card-tools.svg?v=3" width="100%" alt="Herramientas &amp; Tech" />
    </td>
  </tr>
</table>
...
<!-- SECCIÓN: EXPERIENCIA -->
<a id="experiencia"></a>
<h2 style="color: #ff007f; font-family: 'MS Sans Serif', Arial, sans-serif; font-size: 24px; margin-bottom: 25px;">Experiencia &amp; Proyectos</h2>

<table border="0" width="100%" cellpadding="0" cellspacing="0">
  <!-- Fila 1: 2026 -->
  <tr>
    <td width="60" align="center" valign="top" style="padding-top: 5px;">
      <img src="./badge-2026.svg?v=3" width="48" alt="2026" /><br>
      <img src="./line.svg?v=3" width="4" height="90" alt="|" />
    </td>
  ...
  <tr>
    <td width="60" align="center" valign="top" style="padding-top: 5px;">
      <img src="./badge-2025.svg?v=3" width="48" alt="2025" />
    </td>
...
<!-- SECCIÓN: CONTACTO -->
<a id="contacto"></a>
<hr border="1" color="#ff007f" style="opacity: 0.3; margin-bottom: 30px;">
    ...
    <td align="center">
      ...
      <p>
        <a href="mailto:jimenasanzp@gmail.com">
          <img src="./button-email.svg?v=3" height="38" alt="Email" />
        </a>
        &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="https://github.com/hyjimn">
